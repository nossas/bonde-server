class ChangeFunctionCreateCommunityDns < ActiveRecord::Migration
  def up
    execute %{
      ...
      AS $function$
        ...
        begin
          ...
          perform pg_notify('dns_channel', json_build_object(
      ...
      GRANT EXECUTE on FUNCTION microservices.create_community_dns(data json) to postgraphql;
    }
  end
