class AddDaysAgoOnActivistCommunitySearch < ActiveRecord::Migration
  def up
    execute %Q{
drop function postgraphql.search_activists_on_community(text, integer);
CREATE OR REPLACE FUNCTION postgraphql.search_activists_on_community(query text, ctx_community_id integer, days_ago integer)
