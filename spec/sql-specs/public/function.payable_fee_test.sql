BEGIN;
    ...
    returns setof text language plpgsql as $$
        ...
        begin
            ...
            insert into donations(created_at, updated_at, payables)
                values (now(), now(), json_build_array(
                    json_build_object(
                        'id', 'payable_id_1',
                        'fee', 0,
                        'amount', 1000
    ...
    returns setof text language plpgsql as $$
        ...
        begin
            -- insert donation with payables
            insert into donations(amount, created_at, updated_at, payables)
            ...
            -- insert donation with payables
            insert into donations(amount, created_at, updated_at, payables)
                values (1000, '01-01-2016'::timestamp, now(), json_build_array(
                    json_build_object(
                        'id', 'payable_id_1',
                        'fee', 0,
                        'amount', 1000
