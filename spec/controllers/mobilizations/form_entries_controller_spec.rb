...
RSpec.describe Mobilizations::FormEntriesController, type: :controller do
  ...
  describe "POST #create" do
    it "should create with JSON format and parameters" do
      ...
      post :create, mobilization_id: widget.mobilization.id, format: :json, form_entry: { widget_id: widget.id, fields: [{email: 'foo@bar.com'}].to_json }
      ...
      expect(form_entry.fields).to eq([{email: 'foo@bar.com'}].to_json)
    end
  end
end
